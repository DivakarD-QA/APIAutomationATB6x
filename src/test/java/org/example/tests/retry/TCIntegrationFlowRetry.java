package org.example.tests.retry;
...
// Create A Booking, Create a Token
    ...
    public void testCreateBooking(ITestContext iTestContext) {
        ...
        AssertionsForClassTypes.assertThat(bookingResponse.getBookingid()).isNotNull();
        AssertionsForClassTypes.assertThat(bookingResponse.getBooking().getFirstname())
    ...
    public void testVerifyBookingId(ITestContext iTestContext) {
        ...
        AssertionsForClassTypes.assertThat(booking.getFirstname()).isNotNull().isEqualTo("Pramod");
        AssertionsForClassTypes.assertThat(booking.getLastname()).isNotNull().isEqualTo("Stupid");
...
// deser
        ...
        AssertionsForClassTypes.assertThat(booking.getFirstname()).isNotNull().isEqualTo("Naveen");
        AssertionsForClassTypes.assertThat(booking.getLastname()).isNotNull().isEqualTo("King");
